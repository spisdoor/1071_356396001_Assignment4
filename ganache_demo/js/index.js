...
CD_depositButton.on("click", async function() {
  ...
  bank.methods
    ...
    .on("receipt", function(receipt) {
      log(receipt.events.CD_DepositEvent.returnValues, "CD 存款成功 (購買定存)");
...
CD_all_withdrawButton.on("click", async function() {
  ...
  bank.methods
    ...
    .on("receipt", function(receipt) {
      log(receipt.events.CD_all_WithdrawEvent.returnValues, "CD all 提款成功 (合約期滿)");
...
CD_withdrawButton.on("click", async function() {
  ...
  bank.methods
    ...
    .on("receipt", function(receipt) {
      log(receipt.events.CD_WithdrawEvent.returnValues, "CD 提款成功 (提前解約)");
